...
class BaseModel:
    ...
    def get_model_matrix(self):
        ...
        m_model = glm.rotate(m_model, self.rot.y, glm.vec3(1, 1, 0))
...
class Lego(ExtendedBaseModel):
    def __init__(self, app, vao_name='lego', tex_id='lego',
                 pos=(0, 0, 0), rot=(0, 0, 0), scale=(1, 1, 1)):
        super().__init__(app, vao_name, tex_id, pos, rot, scale)
...
class SkyBox(BaseModel):
    ...
    def on_init(self):
        ...
        self.program['m_view'].write(glm.mat4(glm.mat3(self.camera.m_view))) # because sky will not move
